...
module.exports = function validateRegisterInput(data) {
    ...
    data.oldPass = !isEmpty(data.oldPass)
        ? data.oldPass
        : "";
    data.newPass = !isEmpty(data.newPass)
        ? data.newPass
        : "";
    data.newPass2 = !isEmpty(data.newPass2)
        ? data.newPass2
        : "";
    

    if (Validator.isEmpty(data.newPass)) 
        errors.newPass = "Введите ваш пароль";
    else if (!Validator.isLength(data.newPass, {
        min: 4,
        max: 30
    })) 
