...
module.exports = function validateRegisterInput(data) {
  ...
  if (Validator.isEmpty(data.name)) errors.name = 'Укажите ваше имя';
  ...
  if (Validator.isEmpty(data.phone)) errors.phone = 'Укажите ваш телефон';
  ...
  if (Validator.isEmpty(data.city)) errors.city = 'Укажите ваш город';
  else if (!Validator.isLength(data.city, { min: 3 }))
    errors.city = 'Минимальная длинна - 3 символа';

  if (Validator.isEmpty(data.address)) errors.address = 'Укажите ваш адрес';
