      ...
      <div className="register-section">
        <div className="flex-wrap center">
          ...
          >
            ...
            <div
              className="simple-input"
              data-tip={this.state.msg.pass ? this.state.msg.pass : ''}
            >
              <input
                type="password"
                name="pass"
            ...
            <div
              className="simple-input"
              data-tip={this.state.msg.pass2 ? this.state.msg.pass2 : ''}
            >
              <input
                type="password"
                name="pass2"
                ...
                onChange={this.onChange}
                className={this.state.msg.pass2 && 'error'}
              />{' '}
              {this.state.msg.pass2 && (
                <div className="exclam">
                  <img src="/img/exclam-ico.png" alt="" />
                </div>
              )}
