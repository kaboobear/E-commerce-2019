          ...
          <div className="check-block-wrap">
            <div className="check-block">
              ...
              <div className="check-block-info">
                <div className="check-block-title">Сменить почту</div>

                <div className="input-title">Почта</div>
                <div
                  className="simple-input"
                  data-tip={this.state.msg.mail ? this.state.msg.mail : ''}
                >
                  <input
                    type="text"
                    name="mail"
        ...
        >
          <div className="check-block-wrap">
            <div className="check-block">
              ...
              <div className="check-block-info">
                <div className="check-block-title">Сменить пароль</div>

                <div className="input-title">Старый пароль</div>
                <div
                  className="simple-input"
                  data-tip={
                    this.state.msg.oldPass ? this.state.msg.oldPass : ''
                  }
                >
                  <input
                    type="password"
                    ...
                    placeholder="xxxxxx"
                    className={this.state.msg.oldPass && 'error'}
                  />{' '}
                ...
                <div
                  className="simple-input"
                  data-tip={
                    this.state.msg.newPass ? this.state.msg.newPass : ''
                  }
                >
                  <input
                    type="password"
                    ...
                    placeholder="xxxxxx"
                    className={this.state.msg.newPass && 'error'}
                  />{' '}
                ...
                <div
                  className="simple-input"
                  data-tip={
                    this.state.msg.newPass2 ? this.state.msg.newPass2 : ''
                  }
                >
                  <input
                    type="password"
                    ...
                    placeholder="xxxxxx"
                    className={this.state.msg.newPass2 && 'error'}
                  />{' '}
...
export default connect(mapStateToProps, { editMail, editPass, clearErrors })(
  cabinetUser,
);
