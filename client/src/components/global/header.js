        ...
        return (
            <div className="header-section">
                ...
                <div className="container flex-wrap">
                    <NavLink exact className="header-logo" to="/"><span>Sticky</span></NavLink>
                    ...
                    {(isLoading === false) && (
                        <ul className="header-nav desk">
                            ...
                            <li>
                                <NavLink exact className="nav-item" to="/about"><img src="/img/about.png" alt=""/></NavLink>
                            </li>
                            <li>
                                <NavLink exact className="nav-item" to="/faq"><img src="/img/faq.png" alt=""/></NavLink>
                            </li>
                            <li>
                                <NavLink exact className="nav-item" to="/contacts"><img src="/img/phone.png" alt=""/></NavLink>
                            </li>
                        </ul>
                    )}
