                ...
                <Accordion
                    ...
                    <AccordionItem className="history-acc-item">
                        <AccordionItemHeading>
                            <AccordionItemButton className="history-acc-button">Доставка</AccordionItemButton>
                        </AccordionItemHeading>
                    ...
                    <AccordionItem className="history-acc-item">
                        <AccordionItemHeading>
                            <AccordionItemButton className="history-acc-button">Производство</AccordionItemButton>
                        </AccordionItemHeading>
                        <AccordionItemPanel className="history-acc-content">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, vitae animi.
                                Quod, excepturi repellendus numquam doloremque accusamus temporibus cumque
                    ...
                    <AccordionItem className="history-acc-item">
                        <AccordionItemHeading>
                            <AccordionItemButton className="history-acc-button">Дизайн на заказ</AccordionItemButton>
                        </AccordionItemHeading>
                        <AccordionItemPanel className="history-acc-content">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, vitae animi.
                                Quod, excepturi repellendus numquam doloremque accusamus temporibus cumque
                    ...
                    <AccordionItem className="history-acc-item">
                        <AccordionItemHeading>
                            <AccordionItemButton className="history-acc-button">Оптовый заказ</AccordionItemButton>
                        </AccordionItemHeading>
                        <AccordionItemPanel className="history-acc-content">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, vitae animi.
                                Quod, excepturi repellendus numquam doloremque accusamus temporibus cumque
                    ...
                    <AccordionItem className="history-acc-item">
                        <AccordionItemHeading>
                            <AccordionItemButton className="history-acc-button">Сотрудничество</AccordionItemButton>
                        </AccordionItemHeading>
                        <AccordionItemPanel className="history-acc-content">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque, vitae animi.
                                Quod, excepturi repellendus numquam doloremque accusamus temporibus cumque
