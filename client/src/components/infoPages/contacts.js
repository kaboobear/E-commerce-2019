                    ...
                    <div className="info-block">
                        ...
                        <div className="contacts-data">
                            ...
                            <div className="contacts-line">
                                ...
                                <div className="contacts-info">
                                    <span className="city">Кирилл :
                                    </span>
                                    +380931484957
                                    <br/>
                                    <span className="city">Ольга :
                                    </span>
                                    +380635630136
                                    <br/>
                                    <span className="city">Виктор :
                                    </span>
                                    +380931484957
                                </div>
                            </div>
                            ...
                            <div className="contacts-line">
                                ...
                                <div className="contacts-info">
                                    <span className="city">Бизнес :
                                    </span>
                                    sticky.biz@gmail.com
                                    <br/>
                                    <span className="city">Заказ :
                                    </span>
                                    sticky.order@gmail.com
                                    <br/>
                                    <span className="city">Вопросы :
                                    </span>
