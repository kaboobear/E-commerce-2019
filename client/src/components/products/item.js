  ...
  render() {
    return (
      <div className="product-item-wrap">
        <div
          className={`product-item ${this.props.inCart() && 'selected-item'}`}
          key={this.props.elem._id}
        >
          <NavLink
            to={`/item/${this.props.elem._id}`}
            className={`product-item-img${
              this.props.elem.imgName === 'default.png' ? ' no-img' : ''
            }`}
          >
            ...
            <img
              ...
              src={`/img/${
                this.props.elem.imgName !== 'default.png' ? 'uploads/' : ''
              }${this.props.elem.imgName}`}
            />
          </NavLink>

          <div className="product-item-info">
            <div className="product-item-title">{this.props.elem.title}</div>
            ...
            <div
              onClick={() => {
                !this.props.inCart() && this.addToCart();
              }}
