...
class Checkout extends Component {
  ...
  componentDidMount() {
    this.props.user.delivery &&
      this.setState({
        name: this.props.user.delivery.name,
        phone: this.props.user.delivery.phone,
        city: this.props.user.delivery.city,
        address: this.props.user.delivery.address,
      });
  ...
  componentDidUpdate(prevProps) {
    ...
    if (error !== prevProps.error) {
      if (error.id === 'ORDER_ERROR') this.setState({ msg: error.msg });
  ...
  onSubmit = (e) => {
    ...
    total += this.state.delivery === '0' ? 30 : 0;
    cart.total = total;

    const orderData = {
      author: this.props.user ? this.props.user._id : null,
  ...
  render() {
    ...
    return (
      <div className="checkout-section">
        {!this.state.isThanks ? (
          <div>
            <div className="cart-title">Оформление заказа</div>
            ...
            <div className="checkout-wrap">
              <form className="checkout-form" autoComplete="off">
                <div className="check-block-wrap">
                  <div className="check-block">
                    ...
                    <div className="check-block-info">
                      <div className="check-block-title">Доставка</div>
                      ...
                      <div className="check-block-content">
                        <label className="check-label checkout-label">
                          ...
                          <span className="check-text">
                            <div className="check-text-title">Новая Почта</div>

                            <div className="check-text-price">
                              <div className="check-text-word">Цена:</div>
                        ...
                        <label className="check-label checkout-label">
                          ...
                          <span className="check-box"></span>
                          <span className="check-text">
                            <div className="check-text-title">Самовывоз</div>
                ...
                <div className="check-block-wrap">
                  <div className="check-block">
                    ...
                    <div className="check-block-info">
                      <div className="check-block-title">Оплата</div>
                      ...
                      <div className="check-block-content">
                        ...
                        <label className="check-label checkout-label">
                          ...
                          <span className="check-box"></span>
                          <span className="check-text">
                            <div className="check-text-title">Наличными</div>
                ...
                <div className="check-block-wrap">
                  <div className="check-block">
                    ...
                    <div className="check-block-info">
                      <div className="check-block-title">Клиент</div>

                      <div className="input-title">ФИО</div>
                      <div
                        className="simple-input"
                        data-tip={
                          this.state.msg.name ? this.state.msg.name : ''
                        }
                      >
                        <input
                          type="text"
                          ...
                          onChange={this.onChange}
                          className={this.state.msg.name && 'error'}
                        />{' '}
                        {this.state.msg.name && (
                      ...
                      <div
                        className="simple-input"
                        data-tip={
                          this.state.msg.phone ? this.state.msg.phone : ''
                        }
                      >
                        <input
                          type="text"
                          ...
                          onChange={this.onChange}
                          className={this.state.msg.phone && 'error'}
                        />{' '}
                ...
                <div className="check-block-wrap">
                  <div className="check-block">
                    ...
                    <div className="check-block-info">
                      <div className="check-block-title">Локация</div>
                      ...
                      <div
                        className="simple-input"
                        data-tip={
                          this.state.msg.city ? this.state.msg.city : ''
                        }
                      >
                        <input
                          type="text"
                          ...
                          placeholder="Киев"
                          className={this.state.msg.city && 'error'}
                        />{' '}
                        {this.state.msg.city && (
                          <div className="exclam">
                            <img src="/img/exclam-ico.png" alt="" />
                      ...
                      <div
                        className="simple-input"
                        data-tip={
                          this.state.msg.address ? this.state.msg.address : ''
                        }
                      >
                        <input
                          type="text"
                          ...
                          className={this.state.msg.address && 'error'}
                        />{' '}
              ...
              <div className="checkout-details cd2">
                <div className="cart-check">
                  <div className="check-title">Детали</div>

                  <div className="check-line">
                    <div className="check-word">Сумма</div>
                  ...
                  <div className="check-line">
                    <div className="check-word">Доставка</div>
                  ...
                  <div className="check-line">
                    <div className="check-word">Оплата</div>
                  ...
                  <div className="check-line last">
                    <div className="check-word">Итого</div>
          ...
          <div className="cart-msg-wrap">
            <div className="cart-msg">
              <div className="cart-is-empty">Заказ оформлен</div>

              {/* <div className="cart-msg-small">
                                    Ваш заказ будет обработан в ближайшее время
                                </div> */}

              <NavLink to="/" exact className="btn">
