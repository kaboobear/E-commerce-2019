...
class Admin extends Component {
    componentDidMount() {
        this
            .props
            .getItems(1, 10000, 0, 0, 10000000, 0, 1, '', false);
    }
                            ...
                            {user.isAdmin
                                ? (
                                    <div className="admin-section">
                                        ...
                                        <div className="admin-content">
                                            ...
                                            <Route path='/admin/products/add' exact strict component={Add}/>
                                            <Route path='/admin/products' exact component={ProductItems}/>
                                ...
                                : (
                                    <div className="not-admin-panel">
                                        ...
                                        <div onClick={()=>{this.props.logout();}} exact className="btn"><img src="/img/home.svg" alt=""/></div>
                                    </div>
                                )}
                        </Fragment>
                    )
...
export default withRouter(connect(mapStateToProps, {getItems,logout})(Admin));