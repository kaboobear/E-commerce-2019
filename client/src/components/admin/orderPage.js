                            ...
                            <div className="results-block">
                                <div className="results-total">
                                    ...
                                    <div className="total-val">
                                        {order.cart.total}<span className="dollar">грн</span>
                                    </div>
                                </div>
                                            ...
                                            ? (
                                                <Fragment>
                                                    ...
                                                    <div
                                                        ...
                                                        this
                                                            .props
                                                            .changeStatus(order._id, 'finished')
                                                    }}
                                                        className="next-btn">
                                                        Закрыт
                                                        <img src="/img/my-arr-l.svg"/>
...
const mapStateToProps = (state) => ({order: state.order.order, isLoading: state.order.isLoading})

export default connect(mapStateToProps, {getOrderById, changeStatus})(orderPage);