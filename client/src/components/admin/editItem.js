...
class Edit extends Component {
  ...
  onSubmit = (e) => {
    ...
    this.props.editItem(formData, this.props.id, this.props.history);
  };
            ...
            <div className="add-section">
              ...
              >
                <div className="simple-input file-input">
                  <img
                    ...
                    src={
                      ...
                      this.state.filename === 'default.png'
                        ? '/img/default.png'
                ...
                <div
                  ...
                  data-tip={this.state.msg.title ? this.state.msg.title : ''}
                >
                  <input
                    type="text"
                    ...
                    className={this.state.msg.title && 'error'}
                  />{' '}
                ...
                <div
                  className="simple-input"
                  data-tip={
                    this.state.msg.description ? this.state.msg.description : ''
                  }
                >
                  <textarea
                    ...
                    className={this.state.msg.description && 'error'}
                  ></textarea>
                  {this.state.msg.description && (
                    <span className="exclam area">
                      <img src="/img/exclam-ico.png" alt="" />
                    </span>
                  )}
                </div>
                <div
                  className="simple-input"
                  data-tip={this.state.msg.price ? this.state.msg.price : ''}
                >
                  <input
                    type="number"
                    ...
                    onChange={this.onChange}
                    placeholder="Цена"
                    className={this.state.msg.price && 'error'}
                  />{' '}
...
export default withRouter(
  connect(mapStateToProps, { editItem, getItem, clearErrors, setUpdated })(
    Edit,
  ),
);
