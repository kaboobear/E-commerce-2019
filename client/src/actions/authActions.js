import {COUNT_LOADED,COUNT_LOADING,USER_LOADED,AUTH_ERROR,LOGIN_SUCCESS,LOGIN_FAIL,REGISTER_SUCCESS,REGISTER_FAIL,LOGOUT_SUCCESS,CHANGE_MAIL,CHANGE_PASS,SET_DELIVERY} from '../actions/types';
